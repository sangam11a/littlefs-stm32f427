...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_0|GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_7
                          |GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_6);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PB3     ------> SPI3_SCK
    */
    HAL_GPIO_DeInit(GPIOB, MAIN_FM_MISO_Pin|MAIN_FM_SCK_Pin);

    HAL_GPIO_DeInit(MAIN_FM_MOSI_GPIO_Port, MAIN_FM_MOSI_Pin);
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE6     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_2|SMSN_FM_MISO_OBC_Pin|SMSN_FM_MOSI_OBC_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE7     ------> UART7_RX
    */
    HAL_GPIO_DeInit(GPIOE, DEBUG_TX_OBC_Pin|DEBUG_RX_OBC_Pin);
